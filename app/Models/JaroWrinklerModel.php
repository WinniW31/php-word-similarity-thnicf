...
class JaroWrinklerModel extends Model
{
  ...
  public function JaroWinkler($string1, $string2, $PREFIXSCALE = 0.1 )
  {
    ...
    $result = $JaroDistance + $prefixLength * $PREFIXSCALE * (1.0 - $JaroDistance);

    return number_format($result*100,2);
  }

  public function CustomJaroWinkler($string1, $string2, $PREFIXSCALE = 0.1 )
  {
    ...
    $checkstrPOS = $this->findStrPOS($string1 , $string2);
